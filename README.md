...
> Comprehensive cloud infrastructure & deployment automation platform

Designed and built an end-to-end automated infrastructure and deployment pipeline. Utilizing Terraform for IAC to provision AWS resources (EC2, VPC), Ansible for configuration management, and Docker containers managed via Jenkins to establish a robust, automated deployment workflow.

`Terraform` `Docker` `Ansible` `Jenkins` `AWS (EC2, VPC)` `CI/CD`

---

### 💬 [Hashtag](https://github.com/praveenkumar0031/hash-tag) — Real-Time Ephemeral Chat Platform
> Dynamic group communication web application

Built a secure, real-time group messaging web application using the MERN stack. Features live message streaming via Socket.io and custom backend logic enforcing an automatic **24-hour message expiration** system for complete data privacy.
...
| # | Title / Organization | Type | Status / ID |
|---|----------------------|------|-------------|
| 1 | Filimin Financial Literacy Management | Research Paper | ✅ Published (ISJEM02037) |
| 2 | Excherish | Research Paper | ✅ Published |
| 3 | AI ML for Geodata Analysis / ISRO | Course / Training | ✅ Completed |
